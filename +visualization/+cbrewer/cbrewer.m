...
%addpath('./+visualization/+cbrewer')
load('./+visualization/+cbrewer/colorbrewer.mat')
...
%     disp(' ')
    ...
    colormap=visualization.cbrewer.interpolate_cbrewer(cbrew_init, interp_method, ncol);
